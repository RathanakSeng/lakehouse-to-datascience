"""
stream_pisey_shop_orders_cdc_bronze.py
Stream Debezium CDC events for Pisey's shop orders table into its own
Bronze table, lakehouse.bronze.pisey_shop_orders_cdc, committed to the
...
org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.3 \
        /opt/spark/jobs/stream_pisey_shop_orders_cdc_bronze.py
...
SOURCE_TABLE = "orders"
KAFKA_TOPIC = "pisey_shop.public.orders"
TARGET_TABLE = "lakehouse.bronze.pisey_shop_orders_cdc"
CHECKPOINT_LOCATION = "s3a://warehouse/checkpoints/pisey_shop_orders_cdc/"
...
def build_spark() -> SparkSession:
    return (
        ...
        .appName("pisey_shop_orders_cdc_stream")
