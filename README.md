...
| Architecture | Pair 3: Ingestion Layer  | Project: I built a real-time ingestion pipeline with Kafka and Debezium | [Medium →](https://medium.com/@withrathanak/project-i-built-a-real-time-ingestion-pipeline-with-kafka-and-debezium-4cd063a4e1f9)                          |
| Architecture | Pair 4: Processing Layer | Why Spark: processing data at a scale one machine can’t handle | [Medium →](https://medium.com/@withrathanak/why-spark-processing-data-at-a-scale-one-machine-cant-handle-d701f227b303)                                    |
| Architecture | Pair 4: Processing Layer | Processing Bronze into Silver with PySpark: a real transformation pipeline | [Medium →](https://medium.com/@withrathanak/processing-bronze-into-silver-with-pyspark-a-real-transformation-pipeline-9d2b717c607e)                                                                                                                                              |
| Modeling, ETL & Orchestration | Pair 5: Data Modeling | Star schema vs Data Vault: two ways to model the same business | [Medium →](https://medium.com/@withrathanak/star-schema-vs-data-vault-two-ways-to-model-the-same-business-d0cf9af68ef4?sharedUserId=withrathanak)                                                                                                                                              |
| Modeling, ETL & Orchestration | Pair 5: Data Modeling | When the shop keeps changing: building a CDC-fed Silver Data Vault | [Medium →](https://medium.com/@withrathanak/when-the-shop-keeps-changing-building-a-cdc-fed-silver-data-vault-8ba7ef98df64?sharedUserId=withrathanak)                                                                                                                                              |
